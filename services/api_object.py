...
DGIS_API_URI_HINT = os.getenv("DGIS_API_URI_BASE") + "suggests"
DGIS_API_URI_GET_BY_ID = os.getenv("DGIS_API_URI_BASE") + "items/byid"
...
def parse_poi_data(data: dict, dgis_id: str) -> POICreate:
    ...
    close_time_string = schedule_for_monday.get("to") if schedule_for_monday.get("to") != "24:00" else "00:00"
