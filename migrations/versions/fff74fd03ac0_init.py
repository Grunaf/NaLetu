...
Revision ID: fff74fd03ac0
Revises: 
Create Date: 2025-06-07 12:13:27.412780
...
def upgrade():
    ...
    sa.Column('start_cost_rub', sa.Integer(), nullable=False),
    sa.Column('end_time_min', sa.Integer(), nullable=False),
    sa.Column('end_cost_rub', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['end_city_id'], ['route_city.id'], ),
    sa.ForeignKeyConstraint(['route_id'], ['route.id'], ),
    sa.ForeignKeyConstraint(['start_city_id'], ['route_city.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['city_id'], ['route_city.id'], ),
    sa.ForeignKeyConstraint(['transport_option_id'], ['transport_option.id'], ),
    sa.ForeignKeyConstraint(['variant_id'], ['day_variant.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
